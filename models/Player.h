...
class Player
{
  public:
    ...
    const int32_t &getValueOfClan() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getClan() const noexcept;
    ///Set the value of the column clan
    void setClan(const int32_t &pClan) noexcept;
